...
export declare class MemoryPersistence implements Persistence {
    ...
    static createLruPersistence(clientId: ClientId, serializer: JsonProtoSerializer): MemoryPersistence;
    static createEagerPersistence(clientId: ClientId, serializer: JsonProtoSerializer): MemoryPersistence;
    private constructor();
...
export declare class MemoryLruDelegate implements ReferenceDelegate, LruDelegate {
    ...
    constructor(persistence: MemoryPersistence, serializer: LocalSerializer);
    onTransactionStarted(): void;
    onTransactionCommitted(txn: PersistenceTransaction): PersistencePromise<void>;
